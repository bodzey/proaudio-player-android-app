...
private val DarkProAudioColors = ProAudioColors(
    canvas = Color(0xFF091012),
    canvasDeep = Color(0xFF080C0D),
    surface = Color(0xFF111819),
    surfaceRaised = Color(0xFF151D1F),
    surfaceInset = Color(0xFF0D1315),
    border = Color(0x17FFFFFF),
    borderStrong = Color(0x26FFFFFF),
    text = Color(0xFFF4F7F6),
    textSoft = Color(0xFF9AA7A7),
    textMuted = Color(0xFF707C7D),
...
private val LightProAudioColors = ProAudioColors(
    canvas = Color(0xFFF1F4F3),
    canvasDeep = Color(0xFFEDF2F0),
    surface = Color(0xFFFFFFFF),
    surfaceRaised = Color(0xFFF6F8F7),
    surfaceInset = Color(0xFFEDF2F0),
    border = Color(0x21193436),
    borderStrong = Color(0x38193436),
    text = Color(0xFF17292B),
    textSoft = Color(0xFF627274),
    textMuted = Color(0xFF8B9798),
